...
open class TagView: UIButton {
    ...
    @IBInspectable open var paddingY: CGFloat = 8 {
        didSet {
            titleEdgeInsets.top = paddingY
            titleEdgeInsets.bottom = paddingY
        }
    }
    @IBInspectable open var paddingX: CGFloat = 18 {
        didSet {
    ...
    @IBInspectable open var textFont: UIFont = UIFont(name: "Gilroy-Bold", size: 20)! {
        didSet {
